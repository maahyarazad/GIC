...
const countries = [
  ...
  // =========================
  { name: "Bahrain", code: "BH", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Bahrain.pdf"},
  { name: "Iran", code: "IR", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Iran.pdf"},
  { name: "Iraq", code: "IQ", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Iraq.pdf"},
  { name: "Israel", code: "IL", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Israel.pdf"},
  { name: "Jordan", code: "JO", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Jordan.pdf"},
  { name: "Kuwait", code: "KW", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Kuwait.pdf"},
  { name: "Lebanon", code: "LB", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Lebanon.pdf"},
  { name: "Oman", code: "OM", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Oman.pdf"},
  { name: "Palestine", code: "PS", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Palestine.pdf"},
  { name: "Qatar", code: "QA", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Qatar.pdf"},
  { name: "Saudi Arabia", code: "SA", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Saudi.pdf"},
  { name: "Syria", code: "SY", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Syria.pdf"},
  { name: "United Arab Emirates (UAE)", code: "AE", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - United.pdf"},
  { name: "Yemen", code: "YE", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Yemen.pdf"},
  { name: "Türkiye", code: "TR", subRegion: "Middle East (Western Asia)" , filepath: "Middle East - Türkiye.pdf"},

  // =========================
  // NORTH AFRICA - 6
  // =========================
  { name: "Algeria", code: "DZ", subRegion: "North Africa" , filepath: "North Africa - Algeria.pdf"},
  { name: "Egypt", code: "EG", subRegion: "North Africa" , filepath: "North Africa - Egypt.pdf"},
  { name: "Libya", code: "LY", subRegion: "North Africa" , filepath: "North Africa - Libya.pdf"},
  { name: "Morocco", code: "MA", subRegion: "North Africa" , filepath: "North Africa - Morocco.pdf"},
  { name: "Sudan", code: "SD", subRegion: "North Africa" , filepath: "North Africa - Sudan.pdf"},
  { name: "Tunisia", code: "TN", subRegion: "North Africa" , filepath: "North Africa - Tunisia.pdf"},

  // =========================
  // WEST AFRICA - 16
  // =========================
  { name: "Benin", code: "BJ", subRegion: "West Africa", filepath: "West Africa - Benin.pdf" },
  { name: "Burkina Faso", code: "BF", subRegion: "West Africa", filepath: "West Africa - Burkina Faso.pdf" },
  { name: "Cape Verde", code: "CV", subRegion: "West Africa", filepath: "West Africa - Cape Verde.pdf" },
  { name: "Côte d'Ivoire", code: "CI", subRegion: "West Africa", filepath: "West Africa - Côte d'Ivoire.pdf" },
  { name: "Gambia", code: "GM", subRegion: "West Africa", filepath: "West Africa - Gambia.pdf" },
  { name: "Ghana", code: "GH", subRegion: "West Africa", filepath: "West Africa - Ghana.pdf" },
  { name: "Guinea", code: "GN", subRegion: "West Africa", filepath: "West Africa - Guinea.pdf" },
  { name: "Guinea-Bissau", code: "GW", subRegion: "West Africa", filepath: "West Africa - Guinea-Bissau.pdf" },
  { name: "Liberia", code: "LR", subRegion: "West Africa", filepath: "West Africa - Liberia.pdf" },
  { name: "Mali", code: "ML", subRegion: "West Africa", filepath: "West Africa - Mali.pdf" },
  { name: "Mauritania", code: "MR", subRegion: "West Africa", filepath: "West Africa - Mauritania.pdf" },
  { name: "Niger", code: "NE", subRegion: "West Africa", filepath: "West Africa - Niger.pdf" },
  { name: "Nigeria", code: "NG", subRegion: "West Africa", filepath: "West Africa - Nigeria.pdf" },
  { name: "Senegal", code: "SN", subRegion: "West Africa", filepath: "West Africa - Senegal.pdf" },
  { name: "Sierra Leone", code: "SL", subRegion: "West Africa", filepath: "West Africa - Sierra Leone.pdf" },
  { name: "Togo", code: "TG", subRegion: "West Africa", filepath: "West Africa - Togo.pdf" },

  // =========================
  // CENTRAL AFRICA - 9
  // =========================
  { name: "Angola", code: "AO", subRegion: "Central Africa" , filepath: "Central Africa - Angola.pdf"},
  { name: "Cameroon", code: "CM", subRegion: "Central Africa" , filepath: "Central Africa - Cameroon.pdf"},
  { name: "Central African Republic", code: "CF", subRegion: "Central Africa" , filepath: "Central Africa - Central African Republic.pdf"},
  { name: "Chad", code: "TD", subRegion: "Central Africa" , filepath: "Central Africa - Chad.pdf"},
  { name: "Republic of the Congo", code: "CG", subRegion: "Central Africa" , filepath: "Central Africa - Republic of the Congo.pdf"},
  { name: "Democratic Republic of the Congo", code: "CD", subRegion: "Central Africa" , filepath: "Central Africa - Democratic Republic of the Congo.pdf"},
  { name: "Equatorial Guinea", code: "GQ", subRegion: "Central Africa" , filepath: "Central Africa - Equatorial Guinea.pdf"},
  { name: "Gabon", code: "GA", subRegion: "Central Africa" , filepath: "Central Africa - Gabon.pdf"},
  { name: "São Tomé and Príncipe", code: "ST", subRegion: "Central Africa" , filepath: "Central Africa - São Tomé and Príncipe.pdf"},

  // =========================
  // EAST AFRICA - 14
  // =========================
  { name: "Burundi", code: "BI", subRegion: "East Africa" , filepath: "East Africa - Burundi.pdf"},
  { name: "Comoros", code: "KM", subRegion: "East Africa" , filepath: "East Africa - Comoros.pdf"},
  { name: "Djibouti", code: "DJ", subRegion: "East Africa" , filepath: "East Africa - Djibouti.pdf"},
  { name: "Eritrea", code: "ER", subRegion: "East Africa" , filepath: "East Africa - Eritrea.pdf"},
  { name: "Ethiopia", code: "ET", subRegion: "East Africa" , filepath: "East Africa - Ethiopia.pdf"},
  { name: "Kenya", code: "KE", subRegion: "East Africa" , filepath: "East Africa - Kenya.pdf"},
  { name: "Madagascar", code: "MG", subRegion: "East Africa" , filepath: "East Africa - Madagascar.pdf"},
  { name: "Malawi", code: "MW", subRegion: "East Africa" , filepath: "East Africa - Malawi.pdf"},
  { name: "Mauritius", code: "MU", subRegion: "East Africa" , filepath: "East Africa - Mauritius.pdf"},
  { name: "Mozambique", code: "MZ", subRegion: "East Africa" , filepath: "East Africa - Mozambique.pdf"},
  { name: "Rwanda", code: "RW", subRegion: "East Africa" , filepath: "East Africa - Rwanda.pdf"},
  { name: "Somalia", code: "SO", subRegion: "East Africa" , filepath: "East Africa - Somalia.pdf"},
  { name: "Tanzania", code: "TZ", subRegion: "East Africa" , filepath: "East Africa - Tanzania.pdf"},
  { name: "Uganda", code: "UG", subRegion: "East Africa" , filepath: "East Africa - Uganda.pdf"},

  // =========================
  // SOUTHERN AFRICA - 9
  // =========================
  { name: "Botswana", code: "BW", subRegion: "Southern Africa" , filepath: "Southern Africa - Botswana.pdf"},
  { name: "Eswatini", code: "SZ", subRegion: "Southern Africa" , filepath: "Southern Africa - Eswatini.pdf"},
  { name: "Lesotho", code: "LS", subRegion: "Southern Africa" , filepath: "Southern Africa - Lesotho.pdf"},
  { name: "Namibia", code: "NA", subRegion: "Southern Africa" , filepath: "Southern Africa - Namibia.pdf"},
  { name: "South Africa", code: "ZA", subRegion: "Southern Africa" , filepath: "Southern Africa - South Africa.pdf"},
  { name: "Zambia", code: "ZM", subRegion: "Southern Africa" , filepath: "Southern Africa - Zambia.pdf"},
  { name: "Zimbabwe", code: "ZW", subRegion: "Southern Africa" , filepath: "Southern Africa - Zimbabwe.pdf"},
  { name: "Seychelles", code: "SC", subRegion: "Southern Africa" , filepath: "Southern Africa - Seychelles.pdf"},
  { name: "South Sudan", code: "SS", subRegion: "Southern Africa" , filepath: "Southern Africa - South Sudan.pdf"},
];
        ...
        for (const [index, country] of countries.entries()) {
          ...
          const productDoc = {
            fileId: `${country.filepath.replace('.pdf', '')}`,
            name: country.name,
